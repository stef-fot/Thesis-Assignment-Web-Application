...
class BestAvgGradeStrategyTest{
    ...
    void testcompareApplications() {
        ...
        BestAvgGradeStrategy bestAvg = new BestAvgGradeStrategy();
        int result = bestAvg.compareApplications(app1, app2);
